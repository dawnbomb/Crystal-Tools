...
namespace Etrian_Odyssey_IV_test
{
	class Table_Manager
	{
		...
		public void setTable(byte[] buffer, int baseA, int eLen, string filename)
		{
		...
		{
			loadEntry(sender, entryAddr);
		}
		public void loadEntry(object sender, int entryAddr2)
		{
			int srcEntry = 0;
